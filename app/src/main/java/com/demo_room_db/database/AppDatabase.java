...
import com.demo_room_db.utils.Converters;


@Database(entities = {Person.class, LoungeCustomer.class}, version = 1, exportSchema = false)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public abstract LoungeDao loungeCustomer();
}
